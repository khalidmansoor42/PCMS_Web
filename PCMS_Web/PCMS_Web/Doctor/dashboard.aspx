                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="list-group col-sm-10 col-sm-offset-1">
                                    ...
                                    <asp:HyperLink ID="diagnosis_btn" runat="server" CssClass="list-group-item" href="diagnoses.aspx"><i class="fa fa-search" style="margin-right: 15px"></i> Diagnosis <label class="small pull-right">Step 3</label></asp:HyperLink>
                                    ...
                                    <asp:HyperLink ID="generalPhysicalExamination_btn" runat="server" CssClass="list-group-item" href="generalPhysicalExamination.aspx"><i class="fa fa-male" style="margin-right: 18px"></i> General Physical Examination <label class="small pull-right">Step 5</label></asp:HyperLink>
                                    <asp:HyperLink ID="systematicExamination_btn" runat="server" CssClass="list-group-item" href="systematicExamination.aspx"><i class="fa fa-bar-chart" style="margin-right: 11px"></i> Systematic Examination <label class="small pull-right">Step 6</label></asp:HyperLink>
                                    ...
                                    <asp:HyperLink ID="Investigation_btn" runat="server" CssClass="list-group-item" href="investigation.aspx"><i class="fa fa-user-secret" style="margin-right: 15px"></i> Investigation <label class="small pull-right">Step 8</label></asp:HyperLink>
                                    <asp:HyperLink ID="medication_btn" runat="server" CssClass="list-group-item" href="systematicMedication.aspx"><i class="fa fa-medkit" style="margin-right: 15px"></i> Medication <label class="small pull-right">Step 9</label></asp:HyperLink>
