                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="list-group col-sm-10 col-sm-offset-1">
                                    ...
                                    <asp:HyperLink ID="mentalStateExamination_btn" runat="server" CssClass="list-group-item" href="mentalStateExamination.aspx"><i class="fa fa-stethoscope" style="margin-right: 15px"></i> Mental State Examination <label class="small pull-right">Step 2</label></asp:HyperLink>
                                    <asp:HyperLink ID="generalPhysicalExamination_btn" runat="server" CssClass="list-group-item" href="generalPhysicalExamination.aspx"><i class="fa fa-male" style="margin-right: 18px"></i> General Physical Examination <label class="small pull-right">Step 3</label></asp:HyperLink>
                                    <asp:HyperLink ID="systematicExamination_btn" runat="server" CssClass="list-group-item" href="systematicExamination.aspx"><i class="fa fa-bar-chart" style="margin-right: 11px"></i> Systemic Examination <label class="small pull-right">Step 4</label></asp:HyperLink>
                                    <asp:HyperLink ID="psychometricEvaluation_btn" runat="server" CssClass="list-group-item" href="psychometricEvaluation.aspx"><i class="fa fa-file-text" style="margin-right: 15px"></i> Psychometric Evaluation <label class="small pull-right">Step 5</label></asp:HyperLink>
                                    <asp:HyperLink ID="Investigation_btn" runat="server" CssClass="list-group-item" href="investigation.aspx"><i class="fa fa-user-secret" style="margin-right: 15px"></i> Investigation <label class="small pull-right">Step 6</label></asp:HyperLink>
                                    <asp:HyperLink ID="diagnosis_btn" runat="server" CssClass="list-group-item" href="diagnoses.aspx"><i class="fa fa-search" style="margin-right: 15px"></i> Diagnosis <label class="small pull-right">Step 7</label></asp:HyperLink>
                                    ...
                                    <asp:HyperLink ID="counselling_btn" runat="server" CssClass="list-group-item" href="counselling.aspx"><i class="fa fa-comments-o" style="margin-right: 15px"></i> Counselling <label class="small pull-right">Step 9</label></asp:HyperLink>
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="list-group-item" href="admission.aspx"><i class="fa fa-sign-in" style="margin-right: 15px"></i> Admission <label class="small pull-right">Step 10</label></asp:HyperLink>
                                    <asp:HyperLink ID="formuation_btn" runat="server" CssClass="list-group-item" href="formulation.aspx"><i class="fa fa-pie-chart" style="margin-right: 15px"></i> Formulation <label class="small pull-right">Step 11</label></asp:HyperLink>
                                    <asp:HyperLink ID="addPicture_btn" runat="server" CssClass="list-group-item" href="addPicture.aspx"><i class="fa fa-picture-o" style="margin-right: 15px"></i> Add Picture <label class="small pull-right">Step 12</label></asp:HyperLink>
                                </div>
                            </div>
                        </div>
                </div>
