                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="list-group col-sm-10 col-sm-offset-1">
                                    ...
                                    <asp:HyperLink ID="psychometricEvaluation_btn" runat="server" CssClass="list-group-item" href="psychometricEvaluation.aspx"><i class="fa fa-file-text" style="margin-right: 15px"></i> Psychometric Evaluation <label class="small pull-right">Step 6</label></asp:HyperLink>
