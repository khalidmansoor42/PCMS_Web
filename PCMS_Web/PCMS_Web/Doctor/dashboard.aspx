                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="list-group col-sm-10 col-sm-offset-1">
                                    ...
                                    <asp:HyperLink ID="addPicture_btn" runat="server" CssClass="list-group-item" href="#"><i class="fa fa-picture-o" style="margin-right: 15px"></i> Add Picture <label class="small pull-right">Step 12</label></asp:HyperLink>
                                </div>
                            </div>
                        </div>
                </div>
