<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/doctorMaster.Master" AutoEventWireup="true" CodeBehind="counselling.aspx.cs" Inherits="PCMS_Web.Doctor.WebForm21" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" ShowFooter="true" OnRowCreated="GridView1_RowCreated" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Suggestion">
                            <ItemTemplate>
                                <asp:TextBox ID="suggesion_txt" runat="server" Text="0"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Remarks">
                            <ItemTemplate>
                                <asp:TextBox ID="comments_area" runat="server" TextMode="MultiLine"></asp:TextBox>
